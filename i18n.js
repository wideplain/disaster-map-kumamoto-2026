...
const STRINGS = {
  ja: {
    ...
    bousaiOnlySnapshotNote: "この時点は内閣府報のみ（県は資料を公表せず）。市町村別の内訳は断水のみです。",
    summaryFireAgencyNote: "死者・負傷者・住家被害は消防庁がまとめた県全体値です。県資料とは集計基準が違い（負傷者は重傷・軽傷等、住家被害は浸水を含む）、前後の時点と数値が大きく変わることがあります。",
  ...
  "easy-ja": {
    ...
    summaryFireAgencyNote: "しぼうしゃ・けがにん・いえの ひがいは くにが まとめた かずです。けんの かずとは かぞえかたが ちがうので、まえや あとの ひと おおきく ちがうことが あります。",
  ...
  en: {
    ...
    bousaiOnlySnapshotNote: "This time point comes only from the Cabinet Office report (the prefecture published nothing). Only water outage is broken down by municipality.",
    summaryFireAgencyNote: "Deaths, injuries and housing damage are prefecture-wide figures compiled by the Fire and Disaster Management Agency. They are counted differently from the prefectural reports, so they can differ sharply from the neighbouring time points.",
  ...
  zh: {
    ...
    bousaiOnlySnapshotNote: "该时点仅有内阁府报告（熊本县未公布资料）。市町村别数据仅有停水。",
    summaryFireAgencyNote: "死亡・受伤・住宅受损为消防厅汇总的全县数值。统计口径与县资料不同，可能与前后时点差异较大。",
  ...
  vi: {
    ...
    bousaiOnlySnapshotNote: "Mốc thời gian này chỉ có báo cáo của Văn phòng Nội các (tỉnh không công bố tài liệu). Chỉ có số hộ mất nước là theo từng địa phương.",
    summaryFireAgencyNote: "Số người chết, bị thương và thiệt hại nhà ở là số liệu toàn tỉnh do Cơ quan Quản lý Phòng cháy và Thảm họa tổng hợp. Cách thống kê khác với báo cáo của tỉnh nên có thể chênh lệch lớn so với các mốc thời gian lân cận.",
  ...
  ko: {
    ...
    bousaiOnlySnapshotNote: "이 시점은 내각부 보고서만 있습니다(현은 자료를 공표하지 않음). 시정촌별 내역은 단수뿐입니다.",
    summaryFireAgencyNote: "사망·부상·주택 피해는 소방청이 집계한 현 전체 값입니다. 현 자료와 집계 기준이 달라 앞뒤 시점과 크게 차이 날 수 있습니다.",
  ...
  fil: {
    ...
    bousaiOnlySnapshotNote: "Ang oras na ito ay mula lang sa ulat ng Cabinet Office (walang inilabas ang prepektura). Tubig lang ang may datos kada munisipalidad.",
    summaryFireAgencyNote: "Ang bilang ng namatay, nasugatan at pinsala sa bahay ay datos ng buong prepektura mula sa Fire and Disaster Management Agency. Iba ang paraan ng pagbibilang kaysa sa ulat ng prepektura, kaya maaaring malaki ang pagkakaiba sa katabing mga oras.",
  ...
  ne: {
    ...
    bousaiOnlySnapshotNote: "यो समयबिन्दुमा क्याबिनेट कार्यालयको प्रतिवेदन मात्र छ (प्रान्तले कागजात प्रकाशन गरेन)। नगरपालिकाअनुसार पानी बन्द मात्र उपलब्ध छ।",
    summaryFireAgencyNote: "मृत्यु, घाइते र घर क्षति अग्नि तथा विपद् व्यवस्थापन एजेन्सीले जुटाएको प्रान्तभरको तथ्याङ्क हो। गणना विधि प्रान्तीय प्रतिवेदनभन्दा फरक भएकाले अघिपछिको समयबिन्दुसँग ठूलो अन्तर हुन सक्छ।",
  ...
  "pt-BR": {
    ...
    bousaiOnlySnapshotNote: "Este momento vem apenas do relatório do Gabinete (a província não publicou dados). Só a falta de água é detalhada por município.",
    summaryFireAgencyNote: "Mortes, feridos e danos às casas são números de toda a província compilados pela Agência de Gestão de Incêndios e Desastres. O critério difere dos relatórios provinciais, então podem variar bastante em relação aos momentos vizinhos.",
  ...
  id: {
    ...
    bousaiOnlySnapshotNote: "Titik waktu ini hanya dari laporan Kantor Kabinet (prefektur tidak menerbitkan data). Hanya gangguan air yang tersedia per kota/kabupaten.",
    summaryFireAgencyNote: "Korban meninggal, luka, dan kerusakan rumah adalah angka satu prefektur yang dihimpun Badan Penanggulangan Kebakaran dan Bencana. Kriteria penghitungannya berbeda dari laporan prefektur sehingga bisa berbeda jauh dari titik waktu sebelum dan sesudahnya.",
  ...
  my: {
    ...
    bousaiOnlySnapshotNote: "ဤအချိန်သည် အစိုးရအဖွဲ့ရုံး၏ အစီရင်ခံစာသာ ဖြစ်သည် (ခရိုင်မှ စာရွက်စာတမ်း မထုတ်ပြန်ပါ)။ မြို့နယ်အလိုက် ရေပြတ်တောက်မှုသာ ရရှိသည်။",
    summaryFireAgencyNote: "သေဆုံးမှု၊ ဒဏ်ရာရမှုနှင့် အိမ်ပျက်စီးမှုများသည် မီးသတ်နှင့် ဘေးအန္တရာယ်စီမံခန့်ခွဲရေးအေဂျင်စီ စုစည်းသည့် ခရိုင်တစ်ခုလုံး၏ ကိန်းဂဏန်းများ ဖြစ်သည်။ ရေတွက်ပုံကွာခြားသဖြင့် ရှေ့နောက်အချိန်များနှင့် များစွာ ကွာနိုင်သည်။",
